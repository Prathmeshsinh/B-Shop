...
def productsearch(request):
    ...
    worddata=word.splite(" ")
    for i in worddata:
       a=Product.objects.filter(Q(Category__categoryname__icontain=i))|Q(name__icontain=i)|Q(price__icontain=i).d
    return render(request,'product.html',{'data':a})
        ...
        try: 
         ...
         if len(a)==0:
                 ...
                 return redirect('product_get',x)
                  ...
                  request.session['m']="product alredy exists"
                  return redirect('product_get',x)
        except:
...
RAZOR_KEY_ID = 'rzp_test_grqdNU2NBGTHXz'
RAZOR_KEY_SECRET = 'Dhz2eadXp70iGbsBepb1OvaP' 
